...
public class MyRoomDetailActivity extends AppCompatActivity implements RoomImageOneFragment.GetImageUrlListener,
    ...
    private ParseObject currentSelectedRoom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //currentSelectedRoom = roomObject;
        //get the object passed by the parent activity
        Intent intent = getIntent();
        roomObject = (ParseProxyObject) intent.getSerializableExtra("roomObject");
        Log.i("Intent data, ", "Parcelable extra, " + intent.getParcelableExtra("currentSelectedRoomObject"));
        Log.i("Intent data, ", "Serializable extra, " + intent.getSerializableExtra("roomObject"));

        currentSelectedRoom = intent.getParcelableExtra("currentSelectedRoomObject");
        Log.i("Parcel", "Intent parcel, " + (currentSelectedRoom != null ? currentSelectedRoom.getClassName() : null));
            ...
            if(amenities.get(ctr).equals(true)){
                ...
                switch (ctr){
                    case 0:
                        ...
                        Log.d("View added ", "Size: " + features.size());
            ...
            if (preferences.get(ctr).equals(true)) {
                ...
                switch (ctr) {
                    case 0:
                        ...
                        Log.d("View added ", "Size: " + preferencesAmenities.size());
       ...
       FloatingActionButton fab = findViewById(R.id.edit_room_fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //pass room object to the dialog fragment
                Bundle bundle = new Bundle();
                bundle.putParcelable("selectedRoom", intent.getParcelableExtra("currentSelectedRoomObject"));// putString("roomId", roomId);
                //edit room
